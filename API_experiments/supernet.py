...
if __name__ == "__main__":
    ...
    print("save active subnet to disk")
    torch.save(active_subnet_max.state_dict(), "active_subnet.pth")

    print("load active subnet from disk")
    active_subnet_max.from_pretrained("active_subnet.pth")
    print(f"current subnet: {active_subnet}")
